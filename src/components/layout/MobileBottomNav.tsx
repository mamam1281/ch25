...
const MobileBottomNav: React.FC = memo(() => {
    ...
    const navItems = [
        ...
        },
        {
            label: "보상함",
            to: "/rewards",
            isActive: isActive("/rewards") || isActive("/inventory"),
            dataTour: "nav-rewards",
            icon: (active: boolean) => (
                <svg xmlns="http://www.w3.org/2000/svg" className={clsx("w-6 h-6 mb-1 transition-transform", active ? "scale-110" : "opacity-60")} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={active ? 2.5 : 2} d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2v-7m19 0H3m18 0a2 2 0 00-2-2H5a2 2 0 00-2 2m7-7h4m-4 0a2 2 0 00-2 2v2h8V7a2 2 0 00-2-2m-4 0V3m4 2V3" />
                </svg>
            )
        },
        {
