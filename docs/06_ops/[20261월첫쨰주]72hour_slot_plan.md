...
### **Slot A: 일상 (Routine)**
[이벤트명] CC 전용 실탄 충전 (CC Ammo Refill)
[한 줄 소개]
- 게임 3판 플레이 보상을 CC 플랫폼에서 즉시 사용 가능한 '특수 아이템'으로 지급합니다.
[목표]
- 앱 내 플레이를 외부 플랫폼 CC에서의 실제 액션으로 연결
- CC 내 정착을 위한 기초 '실탄(아이템/버프)' 공급
[기간]
- 화요일 상시
[참여 조건(핵심 규칙)]
- 앱 내 게임 3판 완료 + CC 계정 연동 확인
[보상 설계]
- **보상**: CC 전용 고효율 아이템 번들
- **지급 방식**: 미션 탭 수령 시 CC 인벤토리로 자동 발송(API 연동)
[유저 화면 노출]
- 미션 제목: "CC 정복을 위한 준비물! 3판만 하고 실탄 받기"

### **Slot B: 피크 (Peak)**
[이벤트명] CC 연동 고배당 버닝 (CC-Linked High-Roll)
[한 줄 소개]
- 21:00 ~ 22:00 사이, 고배당 획득 시 CC 플랫폼 내 '명예 칭호'와 '추가 혜택'이 동시 부여됩니다!
[목표]
- 고액 자산 소진(Burning)과 외부 플랫폼 내 '지위(Status)' 결합
- CC 플랫폼 내에서의 경쟁 심리 및 자부심 자극 (Retention 인듀스)
[기간]
- 화요일 21:00 ~ 22:00
[참여 조건]
- 해당 시간 내 100배수 이상 잭팟 달성자
[보상 설계]
- **혜택**: CC 내 특수 이펙트(오라/엠블럼) + 차주 CC 전용 리워드 우선권
[유저 화면 노출]
- 알림: "지금 터트리면 CC에서도 주인공! 잭팟 버닝 타임 OPEN"

### **Slot C: 전환 (Conv.)**
[이벤트명] CC VIP 패스 포인트 전환 (CC VIP Access Burning)
[한 줄 소개]
- 내 금고 포인트를 소모하여 CC 플랫폼 내 VIP 전용 구역/이벤트 입장권을 획득하세요!
[목표]
- 내부 인플레이션 자산을 외부 플랫폼의 '희소 권한'으로 전환
- 앱과 외부 플랫폼 간의 강력한 락인(Lock-in) 효과 형성
[기간]
- 화요일 상시
[참여 조건]
- 금고 잔액 50,000P 이상 보유 유저
[보상 설계]
- **혜택**: CC VIP 입장권 또는 고가치 CC 전용 재화 환전
[유저 화면 노출]
- 금고 탭: "이곳의 포인트가 CC의 권력이 됩니다. VIP 패스 환전소"
