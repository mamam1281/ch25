    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            ...
            <div className="p-6 rounded-lg border border-[#333333] bg-[#111111]">
                <h3 className="text-gray-400 text-sm font-medium">Welcome Mission (D-2)</h3>
            ...
            <div className="p-6 rounded-lg border border-[#333333] bg-[#111111]">
                <h3 className="text-gray-400 text-sm font-medium mb-4">Streak Breakdown</h3>
                <div className="flex justify-around items-center">
                    ...
                    <div className="text-center">
                        <p className="text-xs text-gray-500 mb-1">Hot</p>
            ...
            <div className={`p-6 rounded-lg border ${isGoldenHourActive ? 'border-green-500/50 ring-1 ring-green-500/20' : 'border-[#333333]'} bg-[#111111]`}>
                <div className="flex justify-between items-start">
                    <h3 className="text-gray-400 text-sm font-medium">Golden Hour (Yesterday Peak)</h3>
                    {isGoldenHourActive && (
                ...
                <div className="mt-2">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Concurrent Users (21:30-22:30 KST)</p>
                </div>
                {isGoldenHourActive && (
