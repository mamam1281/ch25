...
const RouletteFrame: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    return (
        <div className="relative w-full max-w-[400px] aspect-square flex items-center justify-center">
            ...
            >
                <path style={{ mixBlendMode: 'multiply' }} d="M424.035 881C658.229 881 848.08 683.781 848.08 440.5C848.08 197.217 658.229 0 424.035 0C189.841 0 -0.0116577 197.217 -0.0116577 440.5C-0.0116577 683.781 189.841 881 424.035 881Z" fill="url(#paint0_radial_102_274)" />
                ...
                <path d="M430.304 772.125C632.228 772.125 795.92 613.404 795.92 417.613C795.92 221.823 632.228 63.1028 430.304 63.1028C228.379 63.1028 64.6874 221.823 64.6874 417.613C64.6874 613.404 228.379 772.125 430.304 772.125Z" fill="url(#paint3_linear_102_274)" />
