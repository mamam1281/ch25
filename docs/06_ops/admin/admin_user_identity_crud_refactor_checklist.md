...
- [x] A1. 본사 고유 닉네임 source-of-truth = `user.nickname` 확정(문서 반영)
  ...
  - 증빙: `docs/06_ops/admin/admin_user_identity_crud_refactor_spec_20260103.md`
...
- [x] E2. 운영 적용 계획(시간대/롤백)
  ...
  - 증빙: `docs/06_ops/admin/admin_user_identity_backfill_plan_20260103.md`
...
- [x] F3. 모니터링 지표 정의
  ...
  - 증빙: `docs/06_ops/admin/admin_user_identity_monitoring_20260103.md`
...
- [x] G1. 단계적 롤아웃(백엔드 → 프론트)
  ...
  - 증빙: `docs/06_ops/admin/admin_user_identity_rollout_plan_20260103.md`

- [x] G2. 운영자 가이드 업데이트
  - 완료 기준: 어드민 가이드에 “식별자 입력 규칙/중복 시 409 처리” 반영
  - 증빙: `docs/06_ops/admin/admin_user_guide.md`
