  ...
  return (
    <div className="mx-auto w-full max-w-lg pb-24">
      ...
      <div className="mb-3 flex items-center justify-between gap-2">
        <div className="flex flex-1 items-center gap-1 rounded-2xl border border-white/10 bg-white/5 p-1">
          {TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={clsx(
                  ...
                  "active:scale-[0.98]",
                  isActive ? "bg-figma-primary text-white shadow-lg shadow-emerald-900/20" : "text-white/60 hover:text-white"
                )}
              >
      ...
      <div className="space-y-2">
        {isLoading ? (
          ...
          <div className="rounded-[24px] border border-white/10 bg-white/5 p-5 text-center">
            ...
            <div className="mt-1 text-[11px] font-medium text-white/50">현재 카테고리에 활성 미션이 없습니다.</div>
          </div>
        )}
      </div>
    </div>
